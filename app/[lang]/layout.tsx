...
import { RemoveReactBricksBanner } from '@/components/RemoveReactBricksBanner'
...
export default async function Layout({
  ...
  return (
    <html lang={params.lang} suppressHydrationWarning>
      <body
        className={`${roboto.variable} font-sans dark:bg-gray-900 antialiased`}
      >
        <RemoveReactBricksBanner />
        <ThemeProvider
          attribute="class"
