...
export const bgColors = {
  ...
  SEMI_TRANSPARENT_BLACK: {
    label: tailwindColors.SEMI_TRANSPARENT_BLACK.label,
    value: {
      color: 'rgba(0, 0, 0, 0.5)',
      className: 'bg-black bg-opacity-45',
    },
  },
...
export const highlightTextColors = {
  BLACK: {
    label: 'Black',
    value: { color: '#000000', className: 'text-black' },
  },
  WHITE: {
    label: 'White',
...
export const buttonColors = {
  ...
  BRAND_ORANGE: {
    label: tailwindColors.BRAND_ORANGE.label,
    value: {
      color: tailwindColors.BRAND_ORANGE.color500,
      classNameSolid: 'bg-b-orange text-white hover:bg-orange-500',
      classNameOutline:
        'border border-b-orange-600 text-b-orange-600 dark:border-white dark:text-white',
    },
  },
